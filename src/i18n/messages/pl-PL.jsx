...
export default {
  [LOCALES.POLISH]: {
    greet: 'Cześć, nazywam się',
    jobRole: 'Lubię budować rzeczy internetowe',
    loveGradients: 'No i oczywiście uwielbiam gradienty.',
    resume: 'Życiorys',
    about1: 'Informacje o',
    projects2: 'Projekty',
    contact3: 'Kontakt',
    aboutMe:
      'Trochę o mnie. Mam 29 lat i od roku uczę się programowania stron internetowych, a także języka polskiego. Przez ostatnie 11 lat byłem inżynierem lotnictwa i kosmonautyki, ale na początku 2022 roku zdecydowałem, że nadszedł czas na zmiany. Znalazłem swoją drogę do nauki o komputerach i językach kodowania - i tak szybko do teraz, to jest to, co spędzam dużą część mojego wolnego czasu, ucząc się i budując!',
    connectMe: 'Połączmy się!',
    ...
    footerBody: 'Zaprojektowany i zbudowany przez Oliver Jones',
  },
};
